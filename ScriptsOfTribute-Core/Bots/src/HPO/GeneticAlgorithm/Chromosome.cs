    ...
    public override Gene GenerateGene(int geneIndex)
    {
        ...
        switch(geneIndex) {
            case 0:
                ...
                return new Gene(Math.Round(RandomizationProvider.Current.GetDouble(gene0Min,gene0Max + 1), 3));
            case 1:
                double gene1Min = 0.5;
                double gene1Max = 2.0; //Might want to just set it to root2
                return new Gene(Math.Round(RandomizationProvider.Current.GetDouble(gene1Min,gene1Max + 1), 3));
            case 2:
                int gene2Min = 1;
                int gene2Max = 5;
            ...
            case 3:
                int gene3Min = 1;
                int gene3Max = 5;
                return new Gene(RandomizationProvider.Current.GetInt(gene3Min,gene3Max + 1));
            case 4:
            ...
            case 6:
                ...
                return new Gene(hashGenerationTypes[RandomizationProvider.Current.GetInt(0,hashGenerationTypes.Count+1)]);
            case 7:
                int gene7Min = 1;
            ...
            case 8:
                ...
                return new Gene(scoringMethodTypes[RandomizationProvider.Current.GetInt(0,scoringMethodTypes.Count+1)]);
            case 9:
                var gene9Min = 1;
                var gene9Max = 5;
